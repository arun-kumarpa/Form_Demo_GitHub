...
//	}
	...
	onPress: function(){
		...
		if( !email.match(ck_email) ){
			...
			alert("Json Array data Is :"+ '<br>'+"first name : " + myData.myArray[0].fname +"last name : " + myData.myArray[0].lname + "contact at:"+ myData.myArray[0].cno +"email id :"+ myData.myArray[0].email );
